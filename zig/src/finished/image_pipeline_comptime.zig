...
pub fn quantize(comptime cfg: utils.PipelineConfig, color: f32) f32 {
...
pub fn blur(comptime cfg: utils.PipelineConfig, item: *utils.Color, n: utils.Neighbors) void {
...
pub fn saturation(comptime cfg: utils.PipelineConfig, item: *utils.Color) void {
...
pub fn process(comptime cfg: utils.PipelineConfig, mat: *[utils.SIZE][utils.SIZE]utils.Color) void {
...
pub fn main(init: std.process.Init) !void {
    ...
    // read the image
    var my_image: [utils.SIZE][utils.SIZE]utils.Color = undefined;
