...
pub fn quantize(cfg: utils.PipelineConfig, color: f32) f32 {
...
pub fn blur(cfg: utils.PipelineConfig, item: *utils.Color, n: utils.Neighbors) void {
...
pub fn saturation(cfg: utils.PipelineConfig, item: *utils.Color) void {
...
pub fn process(cfg: utils.PipelineConfig, mat: *[utils.SIZE][utils.SIZE]utils.Color) void {
