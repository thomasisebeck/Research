...
// switch statement
pub fn blur(comptime cfg: utils.PipelineConfig, item: *utils.Colour, n: utils.Neighbours) void {
...
// switch expression
pub fn saturation(comptime cfg: utils.PipelineConfig, item: *utils.Colour) void {
